        ...
        <div class="col-md-8">
            <div class="card card-outline card-info">
                <div class="card-header">
                    <h3 class="card-title">Payment Transaction Information</h3>
                    <div class="card-tools">
                        <a href="<?= site_url('payments/edit/' . $payment['id']) ?>" class="btn btn-sm btn-warning">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="<?= site_url('payments') ?>" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h5>Payment Basics</h5>
                            <table class="table table-bordered table-sm">
                                <tr><th width="40%">Payment #</th><td><?= esc($payment['payment_number']) ?></td></tr>
                                <tr><th>Date</th><td><?= date('d/m/Y', strtotime($payment['payment_date'])) ?></td></tr>
                                <tr><th>Vendor</th><td><?= esc($payment['vendor_name']) ?></td></tr>
                                <tr><th>Bill Reference</th><td><a href="<?= site_url('bills/view/' . $payment['bill_id']) ?>"><?= esc($payment['bill_number']) ?></a></td></tr>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                <tr class="table-success">
                                    <th width="50%">Cash/Bank Amount</th>
