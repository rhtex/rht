    ...
    <div class="card-body">
        <form action="<?= site_url('employees') ?>" method="get" class="row g-3">
            <div class="col-md-5">
                ...
                <input type="text" name="search" id="search" class="form-control" placeholder="Search by name, phone, or email..." value="<?= $filters['search'] ?>">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3 d-flex align-items-end">
                <div class="btn-group w-100">
                    ...
                    <a href="<?= site_url('employees') ?>" class="btn btn-secondary"><i class="fas fa-undo"></i> Reset</a>
                </div>
            </div>
        </form>
    </div>
