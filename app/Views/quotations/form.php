    ...
    <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-end">
                ...
                <li class="breadcrumb-item active"><?= $quotation ? 'Edit' : 'Create' ?></li>
            </ol>
        </div>
    </div>

    <form action="<?= $quotation ? site_url('quotations/update/' . $quotation['id']) : site_url('quotations/store') ?>" method="post">
        <?= csrf_field() ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="date" name="quotation_date" class="form-control" value="<?= $quotation['quotation_date'] ?? date('Y-m-d') ?>" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="form-label">Expiry Date</label>
                            <input type="date" name="expiry_date" class="form-control" value="<?= $quotation['expiry_date'] ?? date('Y-m-d', strtotime('+15 days')) ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="quotation_number" class="form-control fw-bold" value="<?= $quotation['quotation_number'] ?? $quotation_number ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="agent_id" id="agentSelect" class="form-select select2">
                                ...
                                <option value="<?= $agent['id'] ?>" data-commission="<?= $agent['commission_percentage'] ?>" <?= ($quotation && $quotation['agent_id'] == $agent['id']) ? 'selected' : '' ?>>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="transport_name" class="form-select select2">
                                ...
                                <option value="<?= esc($transport['transport_name']) ?>" <?= ($quotation && $quotation['transport_name'] == $transport['transport_name']) ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="waybill_number" class="form-control" value="<?= $quotation['waybill_number'] ?? '' ?>" placeholder="e.g. 123456789">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-bordered" id="itemsTable">
                        ...
                        <tfoot class="table-secondary">
                                ...
                                <td colspan="5" class="text-end">
                                    <div class="input-group input-group-sm justify-content-end" style="width: 250px; float: right;">
                                        ...
                                        <select name="discount_type" id="discount_type" class="form-select form-select-sm" style="max-width: 80px;" onchange="calculateTotals()">
                                            <option value="Fixed" <?= ($quotation['discount_type'] ?? '') == 'Fixed' ? 'selected' : '' ?>>₹</option>
                                            <option value="Percentage" <?= ($quotation['discount_type'] ?? '') == 'Percentage' ? 'selected' : '' ?>>%</option>
                                        </select>
                                        <input type="number" name="discount_amount" id="discount_amount" class="form-control form-control-sm" value="<?= $quotation['discount_amount'] ?? 0 ?>" min="0" step="0.01" onchange="calculateTotals()">
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="shipping_charge" id="shipping_charge" class="form-control" value="<?= $quotation['shipping_charge'] ?? 0 ?>" step="0.01" onchange="calculateTotals()"></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="5" class="text-end">Roundoff:</td>
                                <td><input type="number" name="roundoff_amount" id="roundoff_amount" class="form-control" value="<?= $quotation['roundoff_amount'] ?? 0 ?>" step="0.01" onchange="calculateTotals()"></td>
                                <td></td>
                            </tr>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="terms" class="form-control" rows="3"><?= $quotation['terms'] ?? '1. Quotation valid for 15 days.' ?></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<script>
let rowIndex = <?= $quotation && !empty($quotation['items']) ? count($quotation['items']) : 1 ?>;
