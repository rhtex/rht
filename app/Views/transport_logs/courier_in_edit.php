...
<?php include __DIR__ . '/../layouts/layout-vertical.php'; ?>
        ...
        <h4>Edit Incoming Courier</h4>
        <form action="<?= site_url('/update_transport_logs/'.$log['id']) ?>" method="post">
            <?= csrf_field() ?>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="sender" name="sender" value="<?= $log['sender'] ?>">
                    </div>
                    ...
                    <div class="mb-3" id="othersreasonblockcourierin" style="display: <?= $log['contains'] == 'others' ? 'block' : 'none' ?>;">
