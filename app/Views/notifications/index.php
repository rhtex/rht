...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
        <a href="<?= site_url('notifications/markAllRead') ?>" class="btn btn-sm btn-soft-primary fw-bold rounded-pill px-3">
...
<style>
    ...
    .bg-soft-primary-light { background: #f1f4ff; }
    
    .table-sm td { padding-top: 8px; padding-bottom: 8px; }
    ...
    <ul class="nav nav-pills nav-pills-custom gap-2 mb-3" id="notifyTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="all-tab" data-bs-toggle="pill" data-bs-target="#all" type="button" role="tab">
                ...
                <?php if($unreadAll > 0): ?><span class="badge bg-danger ms-1 smaller"><?= $unreadAll ?></span><?php endif; ?>
            </button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="lr-missing-tab" data-bs-toggle="pill" data-bs-target="#lr-missing" type="button" role="tab">
                ...
                <?php if($unreadLR > 0): ?><span class="badge bg-danger ms-1 smaller"><?= $unreadLR ?></span><?php endif; ?>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="tasks-tab" data-bs-toggle="pill" data-bs-target="#tasks" type="button" role="tab">
                ...
                <?php if($unreadTasks > 0): ?><span class="badge bg-danger ms-1 smaller"><?= $unreadTasks ?></span><?php endif; ?>
            </button>
        </li>
    </ul>
            ...
            <div class="card border-0 shadow-none bg-transparent">
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover table-sm align-middle mb-0" style="border-collapse: separate; border-spacing: 0 4px;">
                            ...
                            <tbody>
                                <?php if(empty($notifications)): ?>
                                    <tr><td colspan="4" class="text-center py-4 text-muted small">No notifications found.</td></tr>
                                <?php else: ?>
                ...
                <table class="table table-hover table-sm align-middle mb-0" style="border-collapse: separate; border-spacing: 0 4px;">
                    <tbody>
                        ...
                        if(empty($stockNotifs)): ?>
                            <tr><td class="text-center py-4 text-muted small">No low stock alerts.</td></tr>
                        <?php else: ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-sm align-middle mb-0" style="border-collapse: separate; border-spacing: 0 4px;">
                    <tbody>
                        ...
                        if(empty($lrNotifs)): ?>
                            <tr><td class="text-center py-4 text-muted small">No LR missing alerts.</td></tr>
                        <?php else: ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-sm align-middle mb-0" style="border-collapse: separate; border-spacing: 0 4px;">
                    <tbody>
                        ...
                        if(empty($taskNotifs)): ?>
                            <tr><td class="text-center py-4 text-muted small">No pending tasks.</td></tr>
                        <?php else: ?>
