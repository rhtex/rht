...
<?php include __DIR__ . '/../layouts/layout-vertical.php'; ?>
        ...
        <form action="<?= base_url('/banks/store-transaction') ?>" method="post">
            <div class="mb-3">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-control" name="payment_others_reason" id="payment_others_reason" required>
                        ...
                        <option value="kolmudhal">Kolmudhal</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="type_of_payment" id="type_of_payment" required>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <a href="/banks/list-statements" class="btn btn-secondary">Back to List</a>
        </form>
    </div>
</div>
