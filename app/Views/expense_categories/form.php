...
<?= $this->section('title') ?><?= isset($category) ? 'Edit Category' : 'Add New Category' ?><?= $this->endSection() ?>
...
<div class="row mb-2">
    ...
    <div class="col-sm-6">
        <a href="<?= site_url('expense_categories') ?>" class="btn btn-secondary float-sm-end">Back</a>
    </div>
</div>
<?= $this->endSection() ?>
