                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?= site_url('vendors') ?>" class="btn btn-outline-secondary" title="Clear Filters"><i class="fas fa-times"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                <thead>
                    ...
                    ?>
                    <tr>
                        <th><a href="<?= getSortLink('vendors.id', $currentSortBy, $currentSortOrder) ?>" class="text-dark text-decoration-none">ID <?= getSortIcon('vendors.id', $currentSortBy, $currentSortOrder) ?></a></th>
                        <th><a href="<?= getSortLink('vendors.name', $currentSortBy, $currentSortOrder) ?>" class="text-dark text-decoration-none">Vendor Name (City) <?= getSortIcon('vendors.name', $currentSortBy, $currentSortOrder) ?></a></th>
                        <th>Contact</th>
                        <th>GSTIN</th>
                ...
                <tbody id="vendorTableBody">
                    <?php if(!empty($vendors)): ?>
                        ...
                        <tr>
                            <td><?= $vendor['id'] ?></td>
                            <td>
                                <strong><a href="<?= site_url('vendors/view/'.$vendor['id']) ?>" class="text-dark"><?= esc($vendor['name']) ?></a></strong>
                                <?php if($vendor['city']): ?>
                            ...
                            <td class="text-end fw-bold <?= $vendor['pending_balance'] >= 0 ? 'text-danger' : 'text-success' ?>">
                                ₹<?= number_format(abs($vendor['pending_balance']), 2) ?> <?= $vendor['pending_balance'] >= 0 ? 'Payable' : 'Advance' ?>
                            </td>
