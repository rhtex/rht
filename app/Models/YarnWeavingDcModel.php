...
class YarnWeavingDcModel extends Model
{
    protected $table            = 'production_yarn_weaving_dcs';
    ...
    protected $validationRules      = [
        'dc_number'     => 'required|is_unique[production_yarn_weaving_dcs.dc_number,id,{id}]',
