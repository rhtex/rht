...
class SalesOrderModel extends Model
{
    ...
    protected $allowedFields    = [
        ...
        'agent_commission_status', 'agent_commission_paid_at', 'quotation_id', 'sales_order_number', 
        'zoho_salesorder_id', 'zoho_sync_status', 'order_date', 'shipment_date',
        'reference_number', 'transport_name', 'waybill_number', 'status', 'subtotal', 'discount_amount', 'discount_type', 
        'shipping_charge', 'roundoff_amount', 'tax_amount', 'total_amount', 'notes', 'terms',
