...
<?= $this->section('header') ?>
<div class="row mb-2">
    <div class="col-sm-6"><h1>Dyeing DC Details</h1></div>
    <div class="col-sm-6 text-end">
        <a href="<?= site_url('production/yarn-dyeing') ?>" class="btn btn-secondary"><i class="fas fa-list"></i> List</a>
        <?php if($dc['status'] !== 'Completed' && $dc['status'] !== 'Cancelled'): ?>
            <a href="<?= site_url('production/yarn-dyeing/receipt-create/'.$dc['id']) ?>" class="btn btn-success"><i class="fas fa-download"></i> Receive Yarn</a>
        <?php endif; ?>
    </div>
</div>
<?= $this->endSection() ?>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong><?= esc($item['required_color']) ?></strong></td>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 text-end">
                                <a href="<?= site_url('production/yarn-dyeing/receipt-delete/'.$r['id']) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Revert and delete this receipt?')"><i class="fas fa-trash"></i> Delete Receipt</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-sm table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong><?= esc($ri['received_color']) ?></strong></td>
