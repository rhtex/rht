...
class YarnTwistingDcModel extends Model
{
    protected $table            = 'production_yarn_twisting_dcs';
    ...
    protected $validationRules      = [
        'dc_number'     => 'required|is_unique[production_yarn_twisting_dcs.dc_number,id,{id}]',
