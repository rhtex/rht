...
class YarnWeavingReceiptModel extends Model
{
    protected $table            = 'production_yarn_weaving_receipts';
    ...
    protected $validationRules      = [
        ...
        'receipt_number' => 'required|is_unique[production_yarn_weaving_receipts.receipt_number,id,{id}]',
