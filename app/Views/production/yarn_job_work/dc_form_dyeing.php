...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><?= isset($dc) ? 'Edit Dyeing DC' : 'Create Dyeing DC' ?></h1>
    </div>
    <div class="col-sm-6 text-end">
        <a href="<?= site_url('production/yarn-job-work?type=Dyeing') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
    </div>
</div>
<?= $this->endSection() ?>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control bg-light" value="Dyeing" readonly>
                    <input type="hidden" name="job_work_type" value="Dyeing">
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <table class="table table-bordered" id="itemsTable">
                        <thead>
                            <tr class="bg-light">
                                ...
                                <th>Details</th>
                                <th width="20%">Required Color (Dyeing) <span class="text-danger">*</span></th>
                        ...
                        <tbody>
                            <?php if (isset($dcItems) && !empty($dcItems)): ?>
                                ...
                                <tr id="row-<?= $idx ?>">
                                    ...
                                    <td>
                                        <input type="text" name="items[<?= $idx ?>][required_color]" class="form-control input-required-color" value="<?= esc($item['required_color']) ?>" placeholder="e.g. Royal Blue" required>
                                    </td>
                                    <td>
        ...
        function addRow() {
            ...
            var rowHtml = `
                <tr id="row-${rowIndex}">
                    ...
                    <td>
                        <input type="text" name="items[${rowIndex}][required_color]" class="form-control input-required-color" placeholder="e.g. Royal Blue" required>
                    </td>
                    <td>
