...
class YarnTwistingReceiptModel extends Model
{
    protected $table            = 'production_yarn_twisting_receipts';
    ...
    protected $validationRules      = [
        ...
        'receipt_number' => 'required|is_unique[production_yarn_twisting_receipts.receipt_number,id,{id}]',
