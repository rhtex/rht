            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/customers/edit/<?= $customer['customer_id'] ?>" method="post">
                        <input type="hidden" value="<?= $customer['zoho_contact_id'] ?>" name="zoho_contact_id">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="contact_name" id="contact_name" class="form-control" value="<?= $customer['contact_name'] ?>" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="credit_limit" class="form-label">Credit Limit:</label>
                                <input type="text" name="credit_limit" id="credit_limit" value="<?= $customer['credit_limit'] ?>" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="tax_type" class="form-label">Tax Type:</label>
                                <select name="tax_type" id="tax_type" class="form-select" required>
                                    <option value="1" <?= $customer['tax_type'] == '1' ? 'selected' : '' ?>>Registered</option>
                                    <option value="2" <?= $customer['tax_type'] == '2' ? 'selected' : '' ?>>Unregistered</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="gst_no" id="gst_no" value="<?= $customer['gst_no'] ?>" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="preferred_transport" class="form-label">Preferred Transport:</label>
                                <input type="text" name="preferred_transport" id="preferred_transport" value="<?= $customer['preferred_transport'] ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="contact_no" class="form-label">Customer Contact Number:</label>
                                <input type="text" name="contact_no" id="contact_no" class="form-control" value="<?= $customer['contact_no'] ?>">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="email" class="form-label">Email:</label>
                                <input type="email" name="email" autocomplete="off" id="email" class="form-control" value="<?= $customer['email'] ?>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="agent" class="form-label">Agent:</label>
                                <input type="text" name="agent" id="agent" class="form-control" value="<?= $customer['agent_id'] ?>">
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="billing_address1" id="billing_address1" class="form-control" value="<?= $billingAddress['address1'] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="billing_address2" class="form-label">Address Line 2:</label>
                        <input type="text" name="billing_address2" id="billing_address2" class="form-control" value="<?= $billingAddress['address2'] ?>">
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="billing_city" class="form-label">City:</label>
                            <input type="text" name="billing_city" id="billing_city" class="form-control" value="<?= $billingAddress['city'] ?>" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="billing_zip" class="form-label">Zip:</label>
                            <input type="text" name="billing_zip" id="billing_zip" class="form-control" value="<?= $billingAddress['zip'] ?>" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="billing_country" id="billing_country" class="form-select" required>
                                ...
                                <option value="India" <?= $billingAddress['country'] == 'India' ? 'selected' : '' ?>>India</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="shipping_address1" id="shipping_address1" class="form-control" value="<?= $shippingAddress['address1'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="shipping_address2" class="form-label">Address Line 2:</label>
                        <input type="text" name="shipping_address2" id="shipping_address2" class="form-control" value="<?= $shippingAddress['address2'] ?>">
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="shipping_zip" id="shipping_zip" class="form-control" value="<?= $shippingAddress['zip'] ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="shipping_country" id="shipping_country" class="form-select">
                                <option value="">Select Country</option>
                                <option value="India" <?= $shippingAddress['country'] == 'India' ? 'selected' : '' ?>>India</option>
                            </select>
                        </div>
                    </div>
                </div>
