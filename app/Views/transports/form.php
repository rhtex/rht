                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="transport_type" class="form-select" required>
                                <option value="Parcel Service" <?= old('transport_type', $isEdit ? ($transport['transport_type'] ?? 'Parcel Service') : 'Parcel Service') === 'Parcel Service' ? 'selected' : '' ?>>Parcel Service</option>
                                <option value="Courier Service" <?= old('transport_type', $isEdit ? ($transport['transport_type'] ?? '') : '') === 'Courier Service' ? 'selected' : '' ?>>Courier Service</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
